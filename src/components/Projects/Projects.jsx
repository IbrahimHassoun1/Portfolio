...
const Projects = () => {
  return (
    <div id='projects' className="min-h-screen containers text-quaternary flex flex-col flex-wrap items-center ">
        ...
        <table className="min-h-72 w-full  flex flex-wrap justify-around mt-3">
            <ProjectCard direction="left" time={100} videoSrc="/tl_alrabaa.mp4" description="This is a real-life e-commerce project designed for Tl-Alrabba tobacco company" title="Tl-Alrabaa" link="https://tl-alrabaa.vercel.app/" code="https://github.com/IbrahimHassoun1/Tl-Alrabaa" features={["Product Catalog","Category & Filters","User Login System","Shopping Cart","Admin Panel","Order History & Tracking","Product Management"]} technologies={[
  ...
  <ProjectCard direction="left" time={100} videoSrc="/Food delivery.mp4" description="This is a full stack practice project for a food delivery website" title="Tomato" link="https://tomato-production-front.vercel.app/" code="https://github.com/IbrahimHassoun1/tomato-production-front" features={["Online Payment","Shopping Cart","User Login System","Product Catalog","Category & Filters","Admin Panel","Order History & Tracking","Product Management"]} technologies={[
